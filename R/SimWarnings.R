...
#'   returned warnings?
#'
#' @param fuzzy logical; group warning messages that differ only slightly into a single
#'   column? Set to \code{FALSE} to report every distinct message separately
#'
#' @references
#'
